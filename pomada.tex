...
\rep{SANDY}                 Je to pravda. To bylo to nejlepší léto mého života.                         (Danny chce Sandy políbit) Danny, co to děláš, pusť mě! Nekaz to!

\rep{DANNY}                  Sandy, já to jen vylepšuji. 

\rep{SANDY}                 Danny, odjíždím, znamená to tedy konec?

\rep{DANNY}                  Samozřejmě že ne. Tohle je začátek. 
